...
QString buildStyle(const QJsonObject& obj)
{
    ...
    if (obj.contains("bold")) {
        ...
        if (Json::ensureBoolean(obj.value("bold"), false)) {
            weight = "bold";
        }
    ...
    if (obj.contains("italic")) {
        ...
        if (Json::ensureBoolean(obj.value("italic"), false)) {
            style = "italic";
        }
...
{
    underline = Json::ensureBoolean(obj.value("underlined"), underline);
    strikethrough = Json::ensureBoolean(obj.value("strikethrough"), strikethrough);
