...
We use [automated backports](https://github.com/sogik/NMCLauncher/blob/dev/.github/workflows/backport.yml) to merge specific contributions from develop into `release` branches.
